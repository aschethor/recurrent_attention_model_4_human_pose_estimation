...
for filtered in [True,False]:
    ...
    plt.ylabel('loss')
    plt.xlabel('batches')
    train_loss = np.loadtxt(open("Logger/logs/{}_{}_train_loss_{}.log".format(model_name,dataset,body_part), "rb"), delimiter=",")
    if filtered:
    ...
    plt.ylabel('accuracy')
    plt.xlabel('batches')
    train_accuracy = np.loadtxt(open("Logger/logs/{}_{}_train_acc_{}.log".format(model_name,dataset,body_part), "rb"), delimiter=",")
    if filtered:
    ...
    if True:
        ...
        plt.ylabel('loss')
        plt.xlabel('batches')
        test_loss = np.loadtxt(open("Logger/logs/{}_{}_test_loss_{}.log".format(model_name,dataset,body_part), "rb"), delimiter=",")
        ...
        plt.ylabel('accuracy')
        plt.xlabel('batches')
        test_accuracy = np.loadtxt(open("Logger/logs/{}_{}_test_acc_{}.log".format(model_name,dataset,body_part), "rb"), delimiter=",")
        test_hits = np.loadtxt(open("Logger/logs/{}_{}_test_hits_{}.log".format(model_name,dataset,body_part), "rb"), delimiter=",")
